...
// NOMBRE DEL ARCHIVO
const string nombreArchivo = "Movimientos Mostaza.txt";
...
//NEW// Keyframes
float posXMostaza = 0.0, posYMostaza = -3.0, posZMostaza = 0.0;
...
void saveFrame(void) //tecla L
{
	...
	if (!archivo) {
		...
		archivo << "KeyFrame: [" << FrameIndex << "] Movimiento de la Mostaza en x: " << movMostaza_x << "\n";
		archivo << "KeyFrame: [" << FrameIndex << "] Movimiento de la Mostaza en y: " << movMostaza_y << "\n";
		archivo << "KeyFrame: [" << FrameIndex << "] Movimiento de la Mostaza en z: " << movMostaza_z << "\n";
		archivo << "KeyFrame: [" << FrameIndex << "] Giro de la Mostaza: " << giroMostaza << "\n";
...
int main()
{
	...
	//Mostaza
	Mostaza = Model();
	Mostaza.LoadModel("Models/Mostaza.obj");
	...
	ofstream archivo;
	if (archivoExiste) {
		// Ya existe, no se agregan los datos de KEYFRAMES 0 AL 5
		//cout << "Ya está el archivo, rey";
	}
	else {
		// No existe, por lo tanto creamos y escribimos los índices iniciales
		archivo.open(nombreArchivo, ios::out);
		for (int i = 0; i < 6; i++) {
			archivo << "KeyFrame: [" << i << "] Movimiento de la mostaza en x: " << KeyFrame[i].movMostaza_x << "\n";
			archivo << "KeyFrame: [" << i << "] Movimiento de la mostaza en y: " << KeyFrame[i].movMostaza_y << "\n";
			archivo << "KeyFrame: [" << i << "] Movimiento de la mostaza en y: " << KeyFrame[i].movMostaza_z << "\n";
			archivo << "KeyFrame: [" << i << "] Giro de la mostaza: " << KeyFrame[i].giroMostaza << "\n\n";
			
		}
		archivo.close();
		cout << "Datos de KeyFrames 0-5 añadidos correctamente.\n";		
	}
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/*model = glm::mat4(1.0);
		posMostaza=glm::vec3(posXMostaza + movMostaza_x, posYMostaza + movMostaza_y, posZMostaza);
		model = glm::translate(model, posMostaza);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		model = glm::rotate(model, giroMostaza * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
...
void inputKeyframes(bool* keys)
{
	...
	/*if (keys[GLFW_KEY_L])
	{
		...
		{
			saveFrame();
			printf("movMostaza_x es: %f\n", movMostaza_x);
			printf("movMostaza_y es: %f\n", movMostaza_y);
